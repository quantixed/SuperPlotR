...
<<<<<<< HEAD
<<<<<<< HEAD:vignettes/going-deeper.Rmd
The best way to "facet" like this and have the correct summary points, is to
make two superplots after filtering the data for A and B, and then combine them
using `patchwork` or similar package.
=======
...
>>>>>>> f264446 (v.0.0.3):vignettes/advanced.Rmd
=======
The best way to "facet" like this and have the correct summary points, is to
make two superplots after filtering the data for A and B, and then combine them
using `patchwork` or similar package.
>>>>>>> 2235435 (Fix: merge docs)
