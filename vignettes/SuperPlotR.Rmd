...
The default SuperPlot includes bars to indicate the mean ± sd. They
can be modified by using the `bars` argument. Options are:
...
Note that these bars show the mean ± error of the _replicate means_ not the
