...
#'  colours in hex format, e.g. c("#FF0000", "#00FF00", "#0000FF").
#'
...
get_sp_colours <- function(n, scheme) {
  ...
  tol_muted <- c('#CC6677', '#332288', '#DDCC77', '#117733', '#88CCEE', '#882255', '#44AA99', '#999933', '#AA4499')
  tol_light <- c('#77AADD', '#EE8866', '#EEDD88', '#FFAABB', '#99DDFF', '#44BB99', '#BBCC33', '#AAAA00', '#DDDDDD')
  ...
  if(scheme == "tol_bright") {
    if (n == 1) {
      ...
      x <- rep(c(, 5, 3, 4, 2, 6, 7), length.out = n)
    }
